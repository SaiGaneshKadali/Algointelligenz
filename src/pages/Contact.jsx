            ...
            <div className="lg:col-span-5 text-left space-y-8">
              ...
              <div className="pt-6 border-t border-slate-100 space-y-3">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.facebook.com/share/1FSecDSNCC/" target="_blank" rel="noreferrer" className="bg-slate-50 border border-slate-100 hover:bg-brand-secondary hover:text-white p-3 rounded-xl text-slate-900 transition-all duration-300 flex items-center justify-center" aria-label="Facebook">
                    <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/algointelligenz?igsh=YTZoM3R2cXU3b3Nw&utm_source=qr&wa_status_inline=true" target="_blank" rel="noreferrer" className="bg-slate-50 border border-slate-100 hover:bg-brand-secondary hover:text-white p-3 rounded-xl text-slate-900 transition-all duration-300 flex items-center justify-center" aria-label="Instagram">
                    <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
